...
<div class="boardTitle">
	...
	$(".boardListTitle").click(function(){
	 ...
	 $(".page-link").click(function(){
		...
		location.href='sendList.ms?userId=${loginUser.userId}&sendListCurrentPage='+btnNo;
	});
	var sendListCurrentPage=${pi.currentPage}
	function prev(){
		location.href='sendList.ms?userId=${loginUser.userId}&sendListCurrentPage='+(sendListCurrentPage-1);
	}
	function next(){
		location.href='sendList.ms?userId=${loginUser.userId}&sendListCurrentPage='+(sendListCurrentPage+1);
	}
