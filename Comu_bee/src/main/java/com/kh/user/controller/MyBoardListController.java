...
public class MyBoardListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		currentPage = Integer.parseInt(request.getParameter("myBoardCurrentPage"));
		...
		request.getRequestDispatcher("views/user/myBoardList.jsp").forward(request, response);
	}
